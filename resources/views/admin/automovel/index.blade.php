...
<div class="container">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-3 text-right" >
            <a href="{{route('automovel.create')}}" class="btn btn-success">
                Adicionar
            </a>
        </div>
    </div>
    ...
    <table class="table table-hover" id="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <strong>
                        <a href="{{route('automovel.show',$val->id)}}" class="text-dark">{{$val->modelo}}</a>
                    </strong>
                </td>
                <td>
                    <a href="{{route('automovel.edit',$val->id)}}" class="btn btn-outline-info btn-sm mr-2">Editar</a>
                    <a href="#" id="a{{$val->id}}" url="{{route('automovel.destroy',$val->id)}}" class="btn btn-outline-danger btn-sm mr-2" onClick="confirmExclusao(a{{$val->id}}, 'esse automovel');">Excluir</a>
                </tr>
            @endforeach
</div>
        </tbody>
