...
<div class="container">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-3 text-right" >
            <a href="{{route('tipoautomovel.create')}}" class="btn btn-success">
                Adicionar
            </a>
        </div>
    </div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="#" id="ta{{$val->id}}" url="{{route('tipoautomovel.destroy',$val->id)}}" class="btn btn-outline-danger btn-sm mr-2" onClick="confirmExclusao(ta{{$val->id}}, 'esse tipo de automovel');">Excluir</a>
                </tr>
            @endforeach
</div>
        </tbody>
